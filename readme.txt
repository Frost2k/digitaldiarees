 ...
 specfic custom files have been created to and are to be used first before editing the parent theme.
	...
	- To add styles 
		- navigate to /meilerlab/assest/css/source.scss
		- add Styles
	...
	- To add scripts 
		- navigate to /meilerlab/js/custom-script.js
		- add any scripts to this file
	- Note
		- These files are enqued in the functions.js file.
 
 The Digital DIAREEs Theme is a modificaiton of the JetBlack Theme and as such the original README text is displayed below:
