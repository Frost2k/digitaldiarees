...
wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/custom-style.css',false,'1.1','all' );

wp_enqueue_script( 'script', get_template_directory_uri() . '/js/custom-script.js', array ( 'jquery' ), 1.1, true);
				...
				while ($query->have_posts()) : $query->the_post();
					...
					<div class="news-card-row">
						<div class="news-card">
							...
							<?php if ( has_post_thumbnail() ) { the_post_thumbnail('large', array( 'class' => 'img-responsive img-rounded news-img' )); } ?>
